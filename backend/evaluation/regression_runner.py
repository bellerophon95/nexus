...
async def run_single_test(question: str, ground_truth: str = None) -> Dict[str, Any]:
    """
...
async def run_regression(dataset_path: str, thresholds: Dict[str, float]):
    ...
    for i, item in enumerate(data):
        ...
        if res["status"] == "failed":
            ...
            print(f"   ✅ Done. Scores: " + ", ".join([f"{k}: {v}" for k, v in res.items() if isinstance(v, (int, float))]))
